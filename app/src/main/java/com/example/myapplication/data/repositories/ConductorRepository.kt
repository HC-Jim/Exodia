...
/**
 * Fuente de datos de ejemplo para el rol Conductor.
 *
 * Actúa como repositorio temporal mientras no exista backend. Al integrar la
 * capa de datos (Room + REST + Firestore) esta clase pasará a implementar la
 * interfaz del repositorio combinando `data/local` y `data/remote`.
 */
